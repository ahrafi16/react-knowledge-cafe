...
const Blog = ({ blog,handleAddBookmark,handleMarkasRead }) => {
    ...
    return (
        <div className='mb-20 space-y-4  border rounded-2xl p-2'>
            ...
            <button onClick={()=> handleMarkasRead(id,reading_time)} className='text-[#6047EC] font-bold underline'>Mark as read</button>
        </div>
    );
};
